...
int main() {
    int c, cod;
    int32_t r;
    // Observatie: Deoarece dimensiunea tipului int difera de la platforma la
    // platforma,
    // (spre exemplu, in Borland C in DOS e reprezentat pe 2 octeti, iar in C sub
    // Linux pe
    // 4 octeti) este necesara utilizarea unor tipuri intregi standard. A se
    // vedea
    // stdint.h.
