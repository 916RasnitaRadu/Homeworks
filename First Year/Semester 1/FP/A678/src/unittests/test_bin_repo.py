...
from src.repository.repository import BinFileRepository
from src.domain.client import Client

class BinRepositoryTest(unittest.TestCase):
    def setUp(self) -> None:
        file_path = "clients_test.pickle"

        self.__repo = BinFileRepository(file_path)
