from PracticWork2.src.Graph.graph import *
from PracticWork2.src.Exceptions.exception import GraphException
from PracticWork2.src.Exceptions.recursion_depth import *
