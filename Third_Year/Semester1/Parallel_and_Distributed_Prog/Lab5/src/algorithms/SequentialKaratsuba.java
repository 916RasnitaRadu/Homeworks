...
public class SequentialKaratsuba {
    ...
    public static Polynomial multiply(Polynomial p1, Polynomial p2) {
        ...
        Polynomial lowP2 = new Polynomial(p1.getCoefficients().subList(0, len));
        Polynomial highP2 = new Polynomial(p1.getCoefficients().subList(len, p2.getCoefficients().size()));
        ...
        // combine (compute the final results)
