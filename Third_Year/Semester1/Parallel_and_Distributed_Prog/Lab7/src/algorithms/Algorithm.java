...
public class Algorithm {
    public static Polynomial multiplySimple(Object o, Object o1, int begin, int end) {
        ...
        Polynomial result = Polynomial.buildEmptyPolynomial(p.getCoefficients().size() * 2 + 1);
    ...
    public static Polynomial karatsubaSequential(Polynomial p1, Polynomial p2) {
        ...
        Polynomial highP1 = new Polynomial(p1.getCoefficients().subList(len, p1.getSize()));
        Polynomial lowP2 = new Polynomial(p2.getCoefficients().subList(0, len));
        Polynomial highP2 = new Polynomial(p2.getCoefficients().subList(len, p2.getSize()));
